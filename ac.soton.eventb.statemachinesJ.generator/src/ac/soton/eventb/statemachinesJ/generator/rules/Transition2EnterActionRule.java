...
public class Transition2EnterActionRule extends AbstractRule  implements IRule {
	...
	/**
	 * Check if the Action can be generated
	 * Note, Generator will not delete user entered actions with the same name as the ones generated by the translator
	 * @param s
	 * @return
	 */
	@SuppressWarnings(value = { "unused" })
	private boolean canGenerate(State s){
		return generatedElements.get(s) == null ||
				!generatedElements.get(s).contains(Strings.ENTER_ + s.getName());
	}
